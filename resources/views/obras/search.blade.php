   ...
   <div class="col s12 m12 l12">
      ...
      <div id="bordered-table" class="card card card-default scrollspy">
         <div class="card-content">
            ...
            <h4 class="card-title">Buscar Obras sociales</h4>

            <form method="get" action="{{ asset( url('obras-admin/search') ) }}" enctype="multipart/form-data" class="form-group mb-2">
                           ...
                           <tbody>
                              @foreach ($legajos as $legajo)
                                 <tr style="height: 10px;">
                                    ...
                                    <td style="height: 40px;padding-bottom: 4px;padding-top: 4px;">
                                       <a class="mb-0 btn waves-effect waves-light cyan" href="\obras-admin\{{ $legajo->id }}">Seleccionar</a>
                                    </td>
                                 </tr>
                              @endforeach
                           </tbody>
