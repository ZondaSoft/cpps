...
<section class="invoice-list-wrapper section" style="margin-top: 0px;">
  ...
  <div class="invoice-filter-action mr-3">
    <form method="post" action="{{ url('/ordenes/print') }}/{{ $id_caja }}" enctype="multipart/form-data" id="formMain" name="formMain">
      {{ csrf_field() }}
...
<script>
  ...
  function pdfexport(e) {
    ...
    document.getElementById('formMain').action="{{ url('/obras/print/') }}";
  ...
  function excel(e) {
    ...
    document.getElementById('formMain').action="{{ url('/obras/excel/') }}";
