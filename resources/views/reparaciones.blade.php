...
<div class="section users-edit">
  <div class="card">
    <div class="card-content" style="padding-top: 0px;">
      ...
      @if($agregar == true)
      <form method="post" action="{{ asset( url('/reparaciones/add') ) }}" enctype="multipart/form-data">
      @else
      <form method="post" action="{{ asset( url('/reparaciones/edit/'.$legajo->id) ) }}" enctype="multipart/form-data">
      @endif
        ...
        <div class="col s12 display-flex content-end mt-2">
          <div class="m6 s6 display-flex content-end">
            <h5 style="margin-top: 7px;margin-bottom: 14px;">Tipos de Reparaciones</h5>
          </div>
          <div class="col m6 s6">
            @if($edicion == true)
              <div class="col s12 display-flex justify-content-end mt-3 mb-1 mr-1">
                ...
                <a href="{{ asset( url('/reparaciones') ) }}" class="btn btn-labeled btn-danger mb-2">
                    <span class="btn-label"><i class="fa fa-times"></i>
                    </span>Cancelar
                </a>
              </div>
            @else
              <a class="waves-effect waves-light btn mb-1 mr-1" href="{{ asset('/reparaciones/add') }}" >Agregar</a>
              <a class="waves-effect waves-light red green btn mb-1 mr-1" href="{{ asset('/reparaciones/edit') }}/{{ $legajo->id }}" style="font-color: withe">Editar</a>
              <a title="Borrar tipo de reparacion" class="waves-effect waves-light red darken-1 btn mb-1 mr-1" style="color: white" onclick="showModalBorrar({{ $legajo->id }})">
